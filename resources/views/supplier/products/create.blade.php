...
@section('title', 'Add New Supplier Item')
...
<div class="page-header animate-fadeInUp mb-4">
    <div class="page-header-left d-flex align-items-center gap-3">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="page-header-title mb-0 fs-3 fw-bold">Add Supply Product Item</h1>
                <p class="page-header-subtitle text-muted mb-0 small">Create a new product listing under your supplier catalog with wholesale pricing, MOQ, and stock availability.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card-panel border-0 shadow-sm rounded-4 p-4 bg-white">
            <form action="{{ route('supplier.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-section mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-8">
                            ...
                            <input type="text" name="name" id="name" class="form-control rounded-3 p-2.5 @error('name') is-invalid @enderror" 
                                   value="{{ old('name') }}" required autofocus placeholder="e.g. Industrial Brass Fitting 1/2 inch">
                            @error('name')
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="sku" id="sku" class="form-control rounded-3 p-2.5 @error('sku') is-invalid @enderror" 
                                   value="{{ old('sku') }}" placeholder="SUPP-FIT-001">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" name="short_description" id="short_description" class="form-control rounded-3 p-2.5 @error('short_description') is-invalid @enderror" 
                               value="{{ old('short_description') }}" placeholder="Brief summary of key specifications...">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="description" id="description" rows="4" class="form-control rounded-3 p-2.5 @error('description') is-invalid @enderror" 
                                  placeholder="Detailed product descriptions, material specifications, warranty...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" name="wholesale_price" id="wholesale_price" class="form-control border-start-0 rounded-end-3 p-2.5 @error('wholesale_price') is-invalid @enderror" 
                                       value="{{ old('wholesale_price') }}" required placeholder="125.00">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" name="cost_price" id="cost_price" class="form-control border-start-0 rounded-end-3 p-2.5 @error('cost_price') is-invalid @enderror" 
                                       value="{{ old('cost_price') }}" required placeholder="100.00">
                            </div>
                            @error('cost_price')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row g-3 mt-1">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="min_order_qty" id="min_order_qty" class="form-control rounded-3 p-2.5 @error('min_order_qty') is-invalid @enderror" 
                                   value="{{ old('min_order_qty', 1) }}" min="1" required>
                            <div class="form-text small">Minimum quantity buyers must order.</div>
                            @error('min_order_qty')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-section mb-4">
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label fw-semibold text-secondary small">Upload Image</label>
                ...
                <div class="pt-4 border-top d-flex align-items-center gap-3">
                    <button type="submit" class="btn btn-primary px-4 py-2.5 rounded-3 fw-semibold" style="background: linear-gradient(135deg, #db2777 0%, #be185d 100%); border: none;">
                        <i class="bi bi-check2-circle me-1 fs-5 align-middle"></i> Save & Publish Product
                    </button>
        ...
        <div class="sticky-top" style="top: 90px;">
            <div class="card-panel border-0 shadow-sm rounded-4 p-4 bg-white mb-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <span class="text-uppercase text-muted fw-bold small letter-spacing-1">Live Catalog Card</span>
                ...
                <div class="product-preview-card p-4 rounded-4 text-center border position-relative overflow-hidden" style="background: linear-gradient(180deg, #fdf2f8 0%, #ffffff 100%);">
                    ...
                    <p class="text-muted small mb-2 font-monospace" id="preview-sku">SKU: SUPP-000</p>

                    {{-- Price & MOQ Box --}}
                    <div class="bg-light p-3 rounded-3 mb-3 border">
                        <div class="fs-4 fw-bold text-dark" id="preview-price">$0.00</div>
